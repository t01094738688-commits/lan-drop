...
> 当前版本：`v0.1.0-beta.1` 早期测试版。适合朋友间测试和小范围使用。
...
| 系统 | 下载文件 |
| --- | --- |
| Windows | `闪传本子-0.1.0-win-x64.exe` |
| macOS Apple Silicon | `闪传本子-0.1.0-mac-arm64.dmg` |
...
- **二维码和访问码**：手机扫码后输入访问码，减少同一局域网内的误访问。
...
```powershell
git tag -a v0.1.0-beta.1 -m "LAN Drop v0.1.0 beta 1"
...
- 增加剪贴板模式：复制文字、链接、图片后自动出现在列表里，手机可一键复制。
