...
> 当前版本：`v0.1.35-beta` 公开测试版。适合小红书、微信和朋友间小范围试用。
...
| 系统 | 下载文件 |
| --- | --- |
| Windows | `闪传本子-0.1.35-win-x64.exe` |
| macOS Apple Silicon | `闪传本子-0.1.35-mac-arm64.dmg` |
| Linux 实验版 | `闪传本子-0.1.35-linux-x86_64.AppImage` / `.deb` |
...
```powershell
git tag -a v0.1.35-beta.1 -m "LAN Drop v0.1.35 beta 1"
git push origin v0.1.35-beta.1
```
