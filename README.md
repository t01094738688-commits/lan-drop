...
> 当前版本：`v0.1.3-beta.1` 早期测试版。适合朋友间测试和小范围使用。
...
| 系统 | 下载文件 |
| --- | --- |
| Windows | `闪传本子-0.1.3-win-x64.exe` |
| macOS Apple Silicon | `闪传本子-0.1.3-mac-arm64.dmg` |
...
```powershell
git tag -a v0.1.3-beta.1 -m "LAN Drop v0.1.3 beta 1"
