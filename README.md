...
> 当前版本：`v0.1.37-beta` 多系统测试版。适合小红书、微信和朋友间小范围试用。
...
```powershell
git tag -a v0.1.37-beta.1 -m "LAN Drop v0.1.37 beta 1"
git push origin v0.1.37-beta.1
```
...
- 软件内“检查更新”目前会打开或复制下载页，还不是完全静默自动覆盖更新。
